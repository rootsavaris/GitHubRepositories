...
class ListRepositoriesFavoritesAdapter(private val activity: Activity, private val clickListener: RepositoryClickListener, private val clickRemoveListener: RepositoryRemoveClickListener) : ListAdapter<RepositoryDataItem, RecyclerView.ViewHolder>(diffCallback) {
    ...
    fun submitNewList(list: List<RepositoryItem>) {
        adapterScope.launch {
            val items = list.map { RepositoryDataItem.RepositoryItemAdapter(it) }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return RepositoryFavoriteViewHolder(binding as AdapterRepositoryFavoriteLineBinding)
    }
